...
In **AuthKitBundle**, the baseline inventory covers **137/137** production units (**113** PHP + **24** Resources under `src/`) as of **2026-08-15** — see [`specs/001-baseline/code-inventory.md`](../specs/001-baseline/code-inventory.md).
