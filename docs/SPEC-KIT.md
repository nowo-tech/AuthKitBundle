...
In **AuthKitBundle**, the baseline inventory covers **151/151** production units (**123** PHP + **28** Resources under `src/`) as of **2026-08-24** — see [`specs/001-baseline/code-inventory.md`](../specs/001-baseline/code-inventory.md).
